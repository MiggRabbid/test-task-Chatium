...
import { refresh, showTextDialog, showToast } from '@app/ui'
import { 
  getRandomIndexes, calcEloRating, howRatingChanged, mapRatingStyle, mapRatingIcon, getCreationDate,
  } from './utils'
...
export const droidsTable = Heap.Table('pictures', {
  ...
  creationDate: Heap.String({default: getCreationDate())
})
...
app.screen('/', async (ctx, req) => {
  ...
  return (
    <screen title="Сравнение дроидов">
